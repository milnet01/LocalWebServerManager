...
| **Last update** | 2026-09-06 (**Seven items shipped and pushed, one commit each; tip is this session's last commit, tree clean.** Five FP09 items — LWSM-1239, 1240, 1241, 1242, 1243, closing the whole `placement.py` cluster except LWSM-1238 — plus two filed and fixed from live user reports the same day, LWSM-1297 and LWSM-1298. `local-ci.sh` green throughout, 1487 tests at the end, no SKIP, no tool drift; every fix mutation-probed and the mutants recorded on its bullet.
