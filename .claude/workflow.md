...
| **Next gate** | **FP08 must close before P04 does.** 15 items left (LWSM-1166 … LWSM-1181); only then does P04 earn `P04-complete`, which is LWSM-1152's gate for the first 0.1.0 release. **P03b remains open and untouched by any of this** — LWSM-1039, LWSM-1008 and LWSM-1121 are still 📋. |
