...
**`LWSM-1007` and `LWSM-1131`: step 1 ✅ (spec accepted at the 2-loop cap),
step 2 ✅ (dependencies). Steps 3–9 NOT started, and deliberately parked** —
the next item worked is `LWSM-1009`, not these. Reset the list when it starts.

1. ✅ Verify spec — both written via `/write-spec`, split, gated 2 loops each,
   accepted 2026-08-13
2. ✅ Verify dependencies — LWSM-1007 declares LWSM-1006 (✅ shipped);
   LWSM-1131 declares LWSM-1007
