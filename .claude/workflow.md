...
| **Next gate** | **FP08 must close before P04 does.** 14 items left (LWSM-1167 … LWSM-1181); only then does P04 earn `P04-complete`, which is LWSM-1152's gate for the first 0.1.0 release. **P03b remains open and untouched by any of this** — LWSM-1039, LWSM-1008 and LWSM-1121 are still 📋. |
...
**`FP08` is the active item and is 5 of 21 done (2026-08-23)** (generated 2026-08-21 by
